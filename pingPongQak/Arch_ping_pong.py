...
### see https://renenyffenegger.ch/notes/tools/Graphviz/attributes/label/HTML-like/index
     ...
     pong >> Edge(color='blue', style='solid',  decorate='true', label='<hit &nbsp; >',  fontcolor='blue') >> ping
     ping >> Edge(color='blue', style='solid',  decorate='true', label='<hit &nbsp; >',  fontcolor='blue') >> pong
diag
