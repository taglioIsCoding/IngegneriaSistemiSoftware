		...
		return { //this:ActionBasciFsm
				state("s0") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="first_hit4",targetState="handle_ball",cond=whenDispatch("ball"))
				}	 
				state("handle_ball") { //this:State
					...
					sysaction { //it:State
					 ...
					 transition(edgeName="next_hit5",targetState="handle_ball",cond=whenDispatch("ball"))
				}	 
			}
		}
} 
